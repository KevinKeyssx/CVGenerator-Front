...
<section class="card p-6 animate-fade-in">
    ...
    {#if isExpanded}
        <form class="mt-6 space-y-5 animate-fade-in-down">
            <!-- Photo Upload -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    <label class="text-sm font-medium text-foreground" for="name">Nombre Completo</label>
                ...
                <div class="space-y-2">
                    <label class="text-sm font-medium text-foreground" for="profession">Titulo Profesional</label>

                    <input 
                        id="profession"
                        aria-label="Titulo Profesional"
                        type="text" 
                        class="input-field"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    <label class="text-sm font-medium text-foreground" for="phone">Telefono</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    <label class="text-sm font-medium text-foreground" for="location">Ubicacion</label>
                ...
                <div class="space-y-2">
                    <label class="text-sm font-medium text-foreground" for="website">Sitio Web</label>
            ...
            <div class="space-y-2">
                <label class="text-sm font-medium text-foreground" for="summary">Resumen Profesional</label>
