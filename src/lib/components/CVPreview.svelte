...
<div class="h-full flex flex-col">
  ...
  <!-- Preview Content -->
  <div class="flex-1 overflow-auto bg-muted/30 p-6 scrollbar-hide">
    <div 
      class="mx-auto transition-transform duration-500 ease-out origin-top"
      style="transform: scale({scale}); width: {100 / scale}%; max-width: {800 / scale}px"
    >
      <div 
